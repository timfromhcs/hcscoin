...
// HCScoin: currency unit renamed BTC -> HCS
const std::string CURRENCY_UNIT = "HCS"; // One formatted unit
const std::string CURRENCY_ATOM = "sat"; // One indivisible minimum value unit

enum class FeeRateFormat {
    BTC_KVB, //!< Use HCS/kvB fee rate unit (identifier kept for compatibility)
