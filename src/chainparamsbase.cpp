...
/**
 * HCScoin RPC ports (P2P ports in parentheses):
 *   main     28332 (28333)   testnet3 28336 (28334)   testnet4 28339 (28338)
 *   signet   28341 (28340)   regtest  28337 (28335)
 * Port numbers for incoming Tor connections (28342+) are chosen to keep
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 28336);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 28339);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 28341);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 28337);
    }
    assert(false);
}
