...
{
    switch (unit) {
    // HCScoin: unit tickers renamed BTC -> HCS
    case Unit::BTC: return QString("HCS");
    case Unit::mBTC: return QString("mHCS");
    case Unit::uBTC: return QString::fromUtf8("µHCS (bits)");
...
{
    switch (unit) {
    // HCScoin: long unit names renamed
    case Unit::BTC: return QString("HCScoins");
    case Unit::mBTC: return QString("Milli-HCScoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-HCScoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
